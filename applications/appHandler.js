...
function getMiddlemanAppPanel() {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription('تقديم وسيط



**__شروط تقديم الوسطاء 

يجب عمرك فوق 14

يجب أن يكون لديك سمعه زينه 

يجب أن يكون لديك دلايل ثقه

يجب أن يكون لديك رقم هاتف

سوف يكون حلف على المصحف __**')
    .setColor('#4F545C')
    .setImage(PANEL_IMAGE);
